              ...
              {({ isVisible }) => (
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <p>
                    ...
                    industry&lsquo;s standard dummy text ever since the 1500s, when an unknown printer took a galley of
                    ...
                    <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                      ...
                      <Tab.Pane eventKey="section">
                        <p>
                          ...
                          asperiores delectus asperiores delectus asperiores delectus quasi inventore debitis quo.
                        </p>
                      </Tab.Pane>
